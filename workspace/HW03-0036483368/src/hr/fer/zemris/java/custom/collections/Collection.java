...
public class Collection {
	 ...
	 * the equals method. It removes only one occurence of given value, it is
	 * not specified which.
	 * 
	 * @param value
	 *            value to be removed
	...
	/**
	 * Allocates new array with size equals to the size of this collection. It
	 * fills array with collection content and returns it. This method never
	...
	/**
	 * Method calls processor.process method for each element of this
	...
	/**
	 * Method adds into this collection all elements from given collection. The
	 * other collection remains unchanged.
	 * 
	 * @param other
	 *            other collection's elements will be added to this collection
	 */
