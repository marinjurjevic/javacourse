...
/**
 * This class is representation of a simple stack. It has 
 * classic methods for working with stack.
 */
public class ObjectStack {
	 ...
	 * @param value value to be pushed on top of the stack
	 * @throws IllegalArgumentException null reference is passed as argument
	 */
	...
	/**
	 * Removes last value pushed on stack from stack and returns it. If
	 * stack is empty when method is called, an exception occurs.
	...
	/**
	 * Returns top element on the stack, without actually removing it
	 * from the stack.
	 * @return object on the top of the stack
	 * @throws EmptyStackException when stack is empty
	 */
