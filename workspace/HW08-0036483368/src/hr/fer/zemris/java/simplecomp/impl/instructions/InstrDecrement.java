...
/**
 * Instrukcija za smanjivanje vrijednosti registra za 1. Instrukcija prima 1
 * argument, registar kojem će se vrijednost koju sadrži smanjiti za jedan </br>
 * Instrukcija <b>ne podržava indirektno adresiranje </b> te radi isključivo
 * izravno s registrima. Instrukcija decrement r0 koja uzima sadržaj registara
 * r0, te gasmanjuje za 1 može se implementirati kako je prikazano u nastavku:
 * 
 * <pre>
 *  decrement r0
 * </pre>
